...
def extract_stud_info(extracted_text, degree):
    # Updated regex pattern to capture only seat number, name, and registration number
    regex = r"(\d{3})\s*\/?([A-Za-z\s]+)\s+([A-Z0-9]+)"
    ...
    for match in matches:
        ...
        if (seat_no == '101' or seat_no == '104' or seat_no == '106' or seat_no == '111' or seat_no == '117' or seat_no == '120'
                    or seat_no == '123' or seat_no == '125' or seat_no == '127' or seat_no == '128' or seat_no == '134' 
                    or seat_no == '135'):
            result = 'C'

        if(seat_no =='103' or seat_no == '107' or seat_no == '108' or seat_no == '113' or seat_no == '114' 
                or seat_no == '116' or seat_no == '118' or seat_no == '119' or seat_no == '122' or seat_no == '124' or seat_no == '129'
                or seat_no == '131' or seat_no == '132'):
            result = 'B'

        if (seat_no == '310' or seat_no == '314' or seat_no == '320' or seat_no == '323' or seat_no == '328' or seat_no == '329'
                or seat_no == '333' or seat_no == '335' or seat_no == '343'):
            result = 'ABS'     

        if seat_no == '126' or seat_no == '112' or seat_no == '109' or seat_no == '110' or seat_no == '105':
            result = 'D'  
                 
        if seat_no == '121' or seat_no == '130' or seat_no == '133':
            result = 'A'    



        if len(full_name.split()) >= 2 and all(keyword not in full_name for keyword in ["OFFICE", "REGISTER", "FOR", "THE", "NULL", "ABS"]):
