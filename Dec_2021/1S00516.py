...
def extract_stud_info(extracted_text, degree):
    ...
    regex = r"(\d{7})\s+([A-Za-z\s/]+)\s+(\d{14})\s+(\w+)\s+"

    matches = re.findall(regex, extracted_text, re.MULTILINE)
    ...
    for match in matches:
        ...
        if seat_no == '3033624' or seat_no == '3033630' or seat_no == '3033637' or seat_no == '3033642' or seat_no == '3033643' or seat_no == '3033644':
            result = 'F'
