...
def extract_stud_info(extracted_text, degree):
    ...
    for match in matches:
        ...
        if len(name.split()) >= 2 and all(keyword not in name for keyword in ["OFFICE", "REGISTER", "FOR", "THE", "NULL"]):# Ensures name has at least two words
            if seat_no not in ("40", "20", "99", "15", "10", "11", "12", "13", "14", "15", "17", "16", "18","19", "21", "22", "23", "24", "25", "26", "27", "28"):#exclude this two seat numbers
