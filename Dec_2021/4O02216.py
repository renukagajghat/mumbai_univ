...
def extract_stud_info(extracted_text, degree):
    ...
    regex = r"(\d{2,7})(?:\s*\/\s*|\s+)([A-Za-z]+(?:\s+[A-Za-z]+)+)\s+.*?(P|F|ABS)\s+"
    ...
    for match in matches:
        ...
        if len(name.split()) >= 2:  # Ensures name has at least two words
            if seat_no not in ("40", "2021", "99", "15", "10", "11", "12", "13", "14", "15", "17", "16", "18","19", "21", "22", "23", "24", "25", "26", "27", "28"):#exclude this two seat numbers
