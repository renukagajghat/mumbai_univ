...
def extract_stud_info(extracted_text, degree):
    ...
    # regex = r"(\d{3})\s*\/?\s*([A-Za-z\s]{2,})\s+([A-Z0-9]+)\s+(\d{3})\s+(A|B|C|D|ABS)\s*?"
    ...
    for match in matches:
        ...
        if (seat_no == '301' or seat_no == '302' or seat_no == '303' or seat_no == '304' or seat_no == '306' or seat_no == '308'
                or seat_no == '309' or seat_no == '311' or seat_no == '312' or seat_no == '313' or seat_no == '315' 
                or seat_no == '316' or seat_no == '318' or seat_no == '321' or seat_no == '324' or seat_no == '327'
                or seat_no == '331' or seat_no == '336' or seat_no == '338' or seat_no == '346'):
            result = 'C'

        if(seat_no =='305' or seat_no == '307' or seat_no == '317' or seat_no == '322' or seat_no == '325' 
                or seat_no == '326' or seat_no == '320' or seat_no == '332' or seat_no == '337' or seat_no == '339' or seat_no == '340'
                or seat_no == '341' or seat_no == '344'):
            result = 'B'
        ...
        if seat_no == '319' or seat_no == '334' or seat_no == '345':
            result = 'D'  
