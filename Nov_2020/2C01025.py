...
def extract_stud_info(extracted_text, degree):
    ...
    # Improved regex to capture seat number, name (including special characters), and PRN
    ...
    for line in lines:
        ...
        # Match result in the same or subsequent lines
        if current_student and re.search(result_regex, line):
            ...
            if result_match:
                ...
                current_student['Degree'] = degree  # Add degree to the student info
                student_info.append(current_student)  # Append the student info to the list
