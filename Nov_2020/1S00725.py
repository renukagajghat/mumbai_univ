...
def extract_stud_info(extracted_text, degree):
    ...
    regex = r"(\d{7})(?:\s*/\s*)?([A-Z\s]{2,})\s+([A-Z0-9]+)\s+(\d{3}|F)\s+"
    ...
    for match in matches:
        ...
        if seat_no == '4088003' or seat_no == '4088007' or seat_no == '4088012' or seat_no == '4088014' or seat_no == '4088016' or seat_no == '4088018' or seat_no == '4088025' or seat_no == '4088030' or seat_no == '4088032' or seat_no == '4088034' or seat_no == '4088035' or seat_no == '4088036' or seat_no == '4088037':
            result = 'F'
        elif seat_no == '4088001':
            result = ''
        else:    
            result = 'P'    

        # # Check if seat_no is in the desired range (501 to 504)
        # if seat_no in ['201', '202', '203', '204', '205', '206', '207', '208', '209', '210', '211', '212'] and len(full_name.split()) > 1:
